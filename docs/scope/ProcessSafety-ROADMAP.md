...
| PS3 | **BUILT 2026-09-21** (branch feat/ps3-qra-studio) | QRA Studio on the vendored engines/hse/qra (canonical 16fd6c9: #230 QRA, #229, and the #231 own-property lookup sweep); `ps_qra_studies` and tile activation migrations written and checked on a local scratch database, NOT APPLIED (owner-run; the owner dry run is in the PR); no pricing change; showcase counts three apps; `ProcessSafety-PS3-STATUS.md` |
