...
const EarthModelingHelpGuide = lazy(() => import('@/pages/apps/EarthModeling/EarthModelingHelpGuide'));
...
const ElectrofaciesStudio = lazy(() => import('@/pages/apps/ElectrofaciesStudio'));
const ElectrofaciesStudioHelpGuide = lazy(() => import('@/pages/apps/ElectrofaciesStudioHelpGuide'));
const ForecastingMlWorkbench = lazy(() => import('@/pages/apps/ForecastingMlWorkbench'));
const ForecastingMlWorkbenchHelpGuide = lazy(() => import('@/pages/apps/ForecastingMlWorkbenchHelpGuide'));
const AiEvaluationStudio = lazy(() => import('@/pages/apps/AiEvaluationStudio'));
const AiEvaluationStudioHelpGuide = lazy(() => import('@/pages/apps/AiEvaluationStudioHelpGuide'));
...
const CarbonAbatementStudio = lazy(() => import('@/pages/apps/CarbonAbatementStudio'));
const FlareToValueStudio = lazy(() => import('@/pages/apps/FlareToValueStudio'));
...
const VerifyExport = lazy(() => import('@/pages/legal/VerifyExport'));
            ...
            <ErrorBoundary>
              <ReservoirProvider>
				...
				<Route path="apps/economics/epe/cases/:caseId/run" element={<ProtectedAppRoute appId="epe-suite" appName="Petroleum Economics Studio"><EpeRunConsole /></ProtectedAppRoute>} />
                                ...
                                <Route path="apps/data-ai/electrofacies-studio" element={<ProtectedAppRoute appId="electrofacies-studio" appName="Electrofacies Studio"><ElectrofaciesStudio /></ProtectedAppRoute>} />
                                <Route path="apps/data-ai/electrofacies-studio/help" element={<ProtectedAppRoute appId="electrofacies-studio" appName="Electrofacies Studio"><ElectrofaciesStudioHelpGuide /></ProtectedAppRoute>} />
                                <Route path="apps/data-ai/forecasting-ml-workbench" element={<ProtectedAppRoute appId="forecasting-ml-workbench" appName="Production Forecasting ML Workbench"><ForecastingMlWorkbench /></ProtectedAppRoute>} />
                                <Route path="apps/data-ai/forecasting-ml-workbench/help" element={<ProtectedAppRoute appId="forecasting-ml-workbench" appName="Production Forecasting ML Workbench"><ForecastingMlWorkbenchHelpGuide /></ProtectedAppRoute>} />
                                <Route path="apps/data-ai/ai-evaluation-studio" element={<ProtectedAppRoute appId="ai-evaluation-studio" appName="AI Evaluation Studio"><AiEvaluationStudio /></ProtectedAppRoute>} />
                                <Route path="apps/data-ai/ai-evaluation-studio/help" element={<ProtectedAppRoute appId="ai-evaluation-studio" appName="AI Evaluation Studio"><AiEvaluationStudioHelpGuide /></ProtectedAppRoute>} />
                                ...
                                <Route path="apps/midstream-downstream/carbon-footprint-abatement" element={<ProtectedAppRoute appId="carbon-footprint-abatement" appName="Carbon Footprint & Abatement Studio"><CarbonAbatementStudio /></ProtectedAppRoute>} />
                                <Route path="apps/midstream-downstream/flare-gas-to-value" element={<ProtectedAppRoute appId="flare-gas-to-value" appName="Flare Gas to Value Studio"><FlareToValueStudio /></ProtectedAppRoute>} />
                              ...
                              <Route path="/legal/verify-export" element={<VerifyExport />} />
