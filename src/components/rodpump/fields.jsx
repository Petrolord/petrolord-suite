// Shared field primitives for the rod pump panels, so every input in
// the studio looks and behaves the same way.
...
export const NumberInput = ({ section, name, step = 'any', ...rest }) => {
