  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        'Overdue: a control has missed its own date. A risk, document or lesson review past due. A peer review past its due date, or a live review with unresolved Critical or Major comments. A change past its target implementation date. A non-conformance, ISO finding or audit finding past its due date. An internal or checklist audit still open past its planned end. An open major nonconformity. A live risk whose residual score is above the appetite its owner set.',
