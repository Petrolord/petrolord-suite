...
import { REPORTED_AUDIT_STATUSES } from '../../shared/findingWorkflow';
 ...
 */
export const AUDIT_LOCKED_STATUSES = REPORTED_AUDIT_STATUSES;
...
/**
 * The finding delete rule and the derived workflow status are shared
 * with ISO Compliance, whose findings carry the same vocabulary.
 */
