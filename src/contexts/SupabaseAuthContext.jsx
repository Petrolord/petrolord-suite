...
const AuthProviderContent = ({ children }) => {
  ...
  const allApps = useMemo(() => [
    ...
    'well-planning',
    'casing-tubing-design-pro', 'torque-drag-studio', 'drilling-fluids-hydraulics', 'well-control-studio', 'cementing-studio', 'completion-design-studio', 'perforation-sand-control', 'stimulation-designer', 'well-integrity-pa', 'well-spacing-optimizer',
