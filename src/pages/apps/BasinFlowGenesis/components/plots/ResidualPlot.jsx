...
const ResidualPlot = ({ roStats, tempStats, depthLabel = 'Depth (m)', tempUnit = '°C' }) => {
    ...
    return (
        <div className="w-full h-full bg-white border border-slate-300 rounded-lg p-4 flex flex-col overflow-hidden relative">
            ...
            <div className="flex-1 grid grid-cols-2 gap-4 min-h-0">
                ...
                <div className="flex flex-col h-full">
                    <h4 className="text-xs text-center text-slate-600 mb-2">Temperature Residuals ({tempUnit})</h4>
                    <div className="flex-1 min-h-0">
                        <ResponsiveContainer width="100%" height="100%">
