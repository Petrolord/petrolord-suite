export default {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        "Dashboard tiles: Audits outstanding (with those past their planned end), Checklist items unanswered (across every audit), Work stopped, still open, and Major nonconformities open.",
        ...
        "Reports: tiles for Audits not delivered, Checklist items unanswered, Work stopped, still open and Actions overdue; the audits planned and not delivered; findings by type, by site and by root cause category; open findings past due.",
    ...
    },
    {
      ...
      bullets: [
        "Nothing is stored until the database update for this app (migration 20260917800000) is applied; its catalogue tile is seeded as Coming Soon.",
