...
export const CONFIG_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      ['pia_new_pml_hct_rate_pct', 'New lease HCT rate', '%'],
      ['pia_gas_in_country_share_pct', 'Gas utilised in Nigeria', '% of gas revenue'],
      ['pia_price_royalty_base', 'Royalty by price benchmark base', ''],
      ['pia_nddc_levy_base', 'NDDC levy base', ''],
      ['pia_nddc_levy_pct', 'NDDC levy', '% of base'],
      ['pia_production_allowance_per_bbl_new_after_cap', 'Production allowance (new lease, after cap)', 'USD/bbl'],
      ['pia_cit_company_gas_operations', 'Company in gas operations (CITA limit exempt)', ''],
      ['pia_decom_escrow_condition_met', 'Decommissioning escrow condition met (NTA s.86)', ''],
    ],
  },
];
...
export const formatConfigValue = (key, value) => {
  ...
  if (typeof value === 'string') {
    const words = {
      ...
      auto: 'Automatic (by year)', force_pia: 'Force PIA-only', force_nta: 'Force NTA 2025',
      regulations_2021: 'Royalty Regulations 2022 (2021 base)', act_2020: 'PIA Seventh Schedule (2020 base)',
      total_budget: 'Total annual budget (OPEX plus CAPEX)', opex: 'OPEX only',
