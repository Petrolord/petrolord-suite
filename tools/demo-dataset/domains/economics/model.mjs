...
export const CONSOLE_DEFAULTS = {
  ...
  pia_cit_rate_pct: 30, pia_tet_rate_pct: null, pia_nddc_levy_pct_of_opex: 3,
  ...
  pia_under_nta_2025_override: 'auto', pia_deep_offshore_hct_interpretation: null,
  ...
  // EC7 (engines 3.12.0): the compliance inputs; a new run is not legacy
  pia_legacy_pre_audit: false, pia_new_pml_hct_rate_pct: null, pia_gas_in_country_share_pct: 0,
  pia_price_royalty_base: 'regulations_2021', pia_nddc_levy_base: 'total_budget', pia_nddc_levy_pct: 3,
  pia_production_allowance_per_bbl_new_after_cap: 4, pia_cit_company_gas_operations: false,
