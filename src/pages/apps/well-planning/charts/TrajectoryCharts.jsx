...
// depth unit.
//
// The section view moved to SectionViewChart (true-scale SVG) after
// the tester case where unequal axes drew a gentle build as a corner.
...
import SectionViewChart from './SectionViewChart';
...
/** Section view: TVD (down) vs vertical section, true scale by
 *  default. The drawing lives in SectionViewChart (SVG, equal aspect);
 *  this export keeps the historical name and props for every caller.
 *  Overlays (WD3 plan-vs-actual, EOU band) are extra series in the same
 *  VS/TVD frame: [{name, rows, color, dash}]. Targets are
 *  [{id, name, vs, tvd}] already projected onto the VS azimuth. */
export const SectionViewPanel = (props) => <SectionViewChart {...props} />;
