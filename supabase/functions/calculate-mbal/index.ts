...
serve(async (req: Request) => {
  ...
  const { data: resultRow, error: resultErr } = await supabaseUser
    ...
    .insert({
      run_id: runRow.id,
      case_id: rbCase.id,
      estimated_ooip_stb: engineResult.estimated_ooip_stb ?? null,
      estimated_ogip_scf: engineResult.estimated_ogip_scf ?? null,
  ...
  return jsonResponse(
    {
      ...
      duration_ms,
      summary: {
        estimated_ooip_stb: engineResult.estimated_ooip_stb,
        estimated_ogip_scf: engineResult.estimated_ogip_scf,
        r_squared: engineResult.r_squared,
        drive_mechanism: engineResult.drive_mechanism,
        aquifer_strength: engineResult.aquifer_strength,
