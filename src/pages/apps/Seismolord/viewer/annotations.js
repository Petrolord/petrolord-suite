...
// The generic half (nice steps, tick formatting, scale bar, north arrow)
// lives in the shared map kit since Mapping MS1 (2026-09-05) and is
// re-exported here by identity; the survey-bound ticks, axes and the
// amplitude colourbar stay in this file.
import {
  niceStepDown, niceStepUp, fmtTick, scaleBarSpec, drawScaleBar, drawNorthArrow,
  FONT, INK, INK_DIM,
} from '@/components/maps/annotations';

export { niceStepDown, niceStepUp, fmtTick, scaleBarSpec, drawScaleBar, drawNorthArrow };
