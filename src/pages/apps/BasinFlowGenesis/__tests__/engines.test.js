 ...
 * (tools/validation/basinflow/, test-data/basinflow/goldens.json).
 *
...
import { HeatTransportEngine } from '../services/HeatTransportEngine';
import { MaturityEngine } from '../services/MaturityEngine';
import { SimulationEngine } from '../services/SimulationEngine';
import { EasyRoWeights, EasyRoFrequencyFactor } from '../services/KerogenLibrary';
import { Spec } from '../services/PhysicsUtils';

const goldens = JSON.parse(fs.readFileSync(
    path.join(__dirname, '../../../../../test-data/basinflow/goldens.json'), 'utf8'));
