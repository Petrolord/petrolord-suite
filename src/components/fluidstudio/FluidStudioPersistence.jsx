    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px] bg-slate-900 text-white border-slate-700">
        ...
        <div className="grid gap-2 py-2">
          ...
          <Input id="fs-project-name" value={projectName} onChange={(e) => setProjectName(e.target.value)} className="bg-slate-800 border-slate-600" placeholder="e.g. Field A blend case" />
        </div>
        <DialogFooter>
    ...
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent className="bg-slate-900 text-white border-slate-700">
        <DrawerHeader>
          ...
          <DrawerDescription>Select a saved project to restore its inputs.</DrawerDescription>
        </DrawerHeader>
