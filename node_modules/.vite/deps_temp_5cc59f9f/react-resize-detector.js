...
var patchResizeCallback = (resizeCallback, refreshMode, refreshRate, refreshOptions) => {
  switch (refreshMode) {
    case "debounce":
      return debounce2(resizeCallback, refreshRate, refreshOptions);
    case "throttle":
...
function useResizeDetector({ skipOnMount = false, refreshMode, refreshRate = 1e3, refreshOptions, handleWidth = true, handleHeight = true, targetRef, observerOptions, onResize, disableRerender = false } = {}) {
  ...
  const [size2, setSize] = (0, import_react.useState)({
    width: void 0,
    height: void 0
  });
  ...
  return Object.assign({ ref: refProxy }, disableRerender ? sizeRef.current : size2);
}
export {
  useResizeDetector
};
