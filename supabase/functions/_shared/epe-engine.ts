// EPE CASH FLOW ENGINE RE-EXPORT SHIM (Economics extraction EC0, 2026-09-08).
// The canonical module now lives in the vendored @petrolord/engines package
// (packages/engines/engines/economics/cashflow.ts, synced via git subtree from Petrolord/petrolord-engines) with
...
export * from '../../../packages/engines/engines/economics/cashflow.ts';
