...
Writes test-data/basinflow/goldens.json: decompaction cases, steady and
...
def main():
    ...
    goldens = {
        "_provenance": {
            "generator": "tools/validation/basinflow/genfixtures.py",
            "spec": "tools/validation/basinflow/oracle.py docstring",
