// Design warnings (Design tab). Every one of these is a real design
// fault the engine detected, phrased as the thing to change. They are
// listed rather than folded into a single status word, because a string
// can be short of depth and multipointing at the same time.
...
const WarningsPanel = () => {
  const { installation } = useGasLift();
  const warnings = installation.design?.warnings || [];
