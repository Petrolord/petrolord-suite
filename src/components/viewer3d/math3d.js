// Shared pure 3D math for the Suite's raw-WebGL2 windows (lifted from
// Seismolord viewer/cube3d.js at the third consumer, Earth Modeling EM6,
// 2026-09-06; Well Design Studio was the second): column-major mat4
// helpers, the orbit camera, cube edges, ray/quad picking and nice
// ticks. No WebGL here (jest-tested through the Seismolord suites).
//
// Model space (right-handed, y up): x and z are the two ground axes in
// normalized units, y is depth or time DOWN (0 at the top, -D at the
// bottom). Survey-specific extents and slice quads stay in Seismolord.
