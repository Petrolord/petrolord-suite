...
/**
 * AS7 — the states the old app could not tell apart.
 *
 * It could not tell them apart because it never asked. No page in
 * Quality Assurance Plan issued a query: the register was six rows in
 * src/data/qa-plan/qaPlanSampleData.js, so a broken database, an
 * organization with no quality plans and a healthy one all rendered the
 * same six invented plans, owned by the same invented people.
 */
 ...
 * src/lib/qualityAssurance.js and says which condition is unmet.
 */
...
/** Shown while migration 20260917500000 is unapplied. */
export const SchemaNotice = () => (
  <div className="mb-4 p-4 rounded-xl border border-[hsl(var(--warning))]/30 bg-[hsl(var(--warning))]/5 text-sm">
    <p className="font-medium">This database has no quality assurance schema yet.</p>
