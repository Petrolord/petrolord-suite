...
// for a well, and the spine already knows the wells and their tests.
// Nothing here changes the design math: the link stores ids, and
// applying a test simply fills the inputs.
